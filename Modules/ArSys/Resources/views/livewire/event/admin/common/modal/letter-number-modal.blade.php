<!-- Modal -->
<div>
    <div wire:ignore.self class="modal fade" id="eventAddLetterNumberModal" tabindex="-1" role="dialog" aria-labelledby="eventAddLetterNumberModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-xs" role="document">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="eventAddLetterNumberModal">Add Letter Number</h5>
                ...
                <div class="modal-body">
                    ...
                    <div wire:ignore class="row">
                        <div class="col-md-4 offset-md-0">
                            <label for="letter_type" class="control-label">Type of Letter</label>
                        </div>
                        <div class="col-md-8 offset-md-0">
                            <div class="form-group">

                                <select class="letter_type" id='letterType' style='width: 260px;' name="letter_type">
                                </select>
                    ...
                    <div class="row">
                        <div class="col-md-4 offset-md-0">
                            <label for="letterNumber" class="control-label">Number</label>
                        </div>
