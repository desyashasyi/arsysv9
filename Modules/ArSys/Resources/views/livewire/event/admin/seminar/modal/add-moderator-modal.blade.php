<!-- Modal -->
<div>
    <div wire:ignore.self class="modal fade" id="adminSeminarModeratorModal" tabindex="-1" role="dialog" aria-labelledby="adminSeminarModeratorModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="adminSeminarModeratorModal">Add Moderator</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-5 offset-md-0">
                            <input wire:model="searchModerator" type="text" class="my-1 form-control" placeholder="Search faculty name">
                        </div>
                    </div>
                    <div class="row">
                        <div class="table-responsive users-table">
