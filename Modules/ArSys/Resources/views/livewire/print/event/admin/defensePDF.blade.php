...
@foreach ($applicants as $applicant)
        ...
        <table width="100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1%" valign="top">:</td>
                    <td text-align="left">{{ \Carbon\Carbon::parse($event->event_date)->format('l,') }}
    ...
    <div id="bodysurat">
        <table width="100%">
            ...
            <tr>
            <td width="70%"> </td>
            <td width="30%">Bandung, @if (\Carbon\Carbon::parse($event->draft_deadline)->format('l') != "Saturday" && \Carbon\Carbon::parse($event->draft_deadline)->format('l') != "Sunday")
                                        {{ \Carbon\Carbon::parse($event->draft_deadline)->format('d F Y')}} <br />
                                    @elseif (\Carbon\Carbon::parse($event->draft_deadline)->format('l') == "Saturday")
                                        {{ \Carbon\Carbon::parse($event->draft_deadline)->subDays(1)->format('d F Y')}} <br />
                                    @elseif (\Carbon\Carbon::parse($event->draft_deadline)->format('l') == "Sunday")
                                        {{ \Carbon\Carbon::parse($event->draft_deadline)->subDays(2)->format('d F Y')}} <br />
                                    @endif
