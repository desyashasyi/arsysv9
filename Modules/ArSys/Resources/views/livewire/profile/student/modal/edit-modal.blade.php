<!-- Modal -->
<div wire:ignore.self class="modal fade" id="editStudentProfileModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editStudentProfile">Edit Student's Profile</h5>
            ...
            <div class="modal-body">
                ...
                <div>
                    <div class="row">
                        <div class="col-md-4 offset-md-0">
                            <label for="student_number">Phone</label>
                        </div>
                ...
                <div wire:ignore class="row">
                    ...
                    <div class="col-md-8 offset-md-0">
                        ...
                        <div class="form-group">
                            ...
                            <select class="study_program" id='editProgramStudy' style='width: 260px;' name="study_program">
                            </select>
                ...
                <div wire:ignore class="row">
                    ...
                    <div class="col-md-8 offset-md-0">
                        <div>{{$study_specialization}}</div>
                        <br>
                        <div class="form-group">

                            <select class="study_specialization" id='editStudySpecialization' style='width: 260px;' name="study_specialization">
                            </select>
                ...
                <div wire:ignore class="row">
                    ...
                    <div class="col-md-8 offset-md-0">
                        <div class="form-group">
                            ...
                            <select class="supervisor" id='editSupervisor' style='width: 260px;' name="supervisor">
                            </select>
            ...
            <div class="modal-footer">
                <button wire:click="update" class="btn btn-sm btn-success"><i class="fas fa-paper-plane"></i> Update</button>
            </div>
       </div>
    </div>
</div>
