<!-- Modal -->
<div wire:ignore.self class="modal fade" id="singleTodoModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" style="width: 100%; height: 100%; overflow-y: scroll; overflow-x: hidden">
