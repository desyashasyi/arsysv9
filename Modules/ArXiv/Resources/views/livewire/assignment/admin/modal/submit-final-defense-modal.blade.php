<!-- Modal -->
<div>
    <div wire:ignore.self class="modal fade" id="submitFinalDefenseAssignmentModal" tabindex="-1" role="dialog" aria-labelledby="submitFinalDefenseAssignmentModal" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-xs" role="document">
        <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="submitFinalDefenseAssignmentModal">Add Assignment Letter</h5>
