<div>
    @include('arxiv::livewire.assignment.admin.modal.submit-final-defense-modal')

    <script>
        window.livewire.on('submitFinalDefenseAssignmentModal', () => {
           $('#submitFinalDefenseAssignmentModal').modal('show');
       });
