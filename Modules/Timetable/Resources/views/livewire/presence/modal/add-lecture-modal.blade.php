<!-- Modal -->
<div wire:ignore.self class="modal fade" id="addLectureModal">
    <div class="modal-dialog  modal-dialog-scrollable" >
       <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addLecture">Add Lecture</h5>
            ...
            <div class="modal-footer">
                <button type="button" wire:click.prevent="submitLecture" class="btn btn-warning btn-sm" ><i class="fa fa-paper-plane"></i> Submit</button>
            </div>
