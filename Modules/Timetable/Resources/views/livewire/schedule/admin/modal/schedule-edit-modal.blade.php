@if($schedule)
        <div wire:ignore.self class="modal fade" id="editScheduleModal_Admin" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog modal-dialog-scrollable" >
            <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editScheduleModal_Admin">SIAK Input</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 offset-md-0">
                                    @foreach($schedule->team as $teacher)
                                        ...
                                        <i style="color:red; cursor:pointer" wire:click = "removeTeacher({{$teacher->id}})" class="fa fa-xs fa-user-minus"></i>
                                        <br>
                                    @endforeach
                                </div>
                            </div>
